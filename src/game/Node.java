...
//    /**
//     * Private helper method (self-defined). If the coin value of this and other are equal,
//     * return neg, 0 or pos depending on whether this id is less than, equal to,
//     * or greater than other's id. Otherwise, return neg, or pos number depending on whether
//     * this's coin value is less than or greater than other's coin value.
//     */
//
//    @Override
//    public int compareTo(Node other) {
//        if (this.tile.coins() == other.tile.coins()) return Long.compare(id, other.id);
//        return other.tile.coins() - this.tile.coins();
//    }
